...
myMain.addEventListener("dragstart" ,(action) => {
    action.dataTransfer.setData("text",action.target.id);
       savingToDoData()
        savingDoingData()
        savingDoneData()
})

toDo.addEventListener("dragover", (action) =>{
...
toDo.addEventListener("drop", (action) =>{
    const targetData = action.dataTransfer.getData("text");
    action.preventDefault();
    action.target.appendChild(document.getElementById(targetData))
   savingToDoData()
        savingDoingData()
        savingDoneData()
})

doing.addEventListener("dragover", (action) =>{
    action.preventDefault();
       savingToDoData()
        savingDoingData()
        savingDoneData()
...
doing.addEventListener("drop", (action) =>{
    const targetData = action.dataTransfer.getData("text");
    action.preventDefault();
    action.target.appendChild(document.getElementById(targetData));
       savingToDoData()
...
done.addEventListener("dragover", (action) =>{
    action.preventDefault();
       savingToDoData()
        savingDoingData()
        savingDoneData()
...
done.addEventListener("drop", (action) =>{
    const targetData = action.dataTransfer.getData("text");
    action.preventDefault();
    action.target.appendChild(document.getElementById(targetData));
       savingToDoData()
